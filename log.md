...
# Day-21: #100DaysOfCode :pencil:
##  `11/06/2021`
---
:ballot_box_with_check: **Updated my [Github](Github) profile [README](https://github.com/foss2cyber) and created a simple workflow for it that fetches my latest blog posts on [Hashnode](https://ishanvelle.hashnode.dev). Completely redesigned it. :star: Shoutout to [@caitlinmpit](https://twitter.com/catalinmpit) for the awesome article on [Hashnode](https://catalins.tech/how-to-create-a-kickass-github-profile-page) & [@rahuldkjain](https://twitter.com/rahuldkjain) for the excellent [Github Profile README Generator](https://rahuldkjain.github.io/gh-profile-readme-generator/)! 🙌️**

:ballot_box_with_check: Take a look at my updated 👉️[profile](https://foss2cyber.github.io/)👈️! 
...
# Day-32 & 33 #100DaysOfCode :pencil:
##  `23/7/2021`

:ballot_box_with_check:&nbsp;`Applied Visual Design almost finished.` 
-
:ballot_box_with_check:&nbsp;`Started learning some more interesting topics in Network Security- Security Hardening, SELinux & Vulnerabilty Scanning in RHEL.` :shield: 😎
-
